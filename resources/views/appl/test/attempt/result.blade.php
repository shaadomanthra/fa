            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="text-center  mt-3 mb-3 mt-md-0 mb-md-0 float-md-right border bg-light p-3 rounded">
                    <div class="mt-4 mt-md-0">Score</div>
                  <div class="display-4">{{ $score }} / {{count($result)}} </div>
                </div>
                <div class="text-center  mt-3 mb-3 mt-md-0 mb-md-0 float-md-right mr-4 border bg-light p-3 rounded">
                    <div class="mt-4 mt-md-0">Band</div>
