...
<div class=" p-4  sidebar ">
<h5 class="mb-0 qshow"><i class="fa fa-th"></i> Questions Pallete <span class="badge badge-warning" id="timer">40:00</span>
<button class="btn btn-outline-light btn-sm float-right" type="button" data-toggle="modal" data-target="#exampleModal">Submit</button></h5>
