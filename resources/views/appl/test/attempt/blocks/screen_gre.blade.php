...
<div class="mb-3">
	...
	<div class="p-2 pl-3 pr-3" style="background:#d5f9f9;"> <b>Section <span class="gre_section">1</span> of {{count($test->sections)}}</b> &nbsp;|&nbsp; Question <span class="gre_qno">1</span> of {{count($test->sections[0]->mcq_order)}}
